#!/bin/bash
#reference : http://keihsler.com/redmine/projects/dw_os_cos6/wiki/Setup_n2n-edge
...
#CONFIGDIR="/etc/n2n"
CONFIGDIR="/home/adel/Dropbox/Github/Developer_Environment_Setup_Script/vpn/n2n"
...
if [[ "${HOST}" == "" ]]; then
      ...
      CONFIGFILE="${CONFIGDIR}/edge-${HOST}.conf"
fi
